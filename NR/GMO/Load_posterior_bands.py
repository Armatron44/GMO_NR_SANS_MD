...
#To get a different contrast, change experiment[0] to experiment[1] or experiment[2] in calc_errors_from_state.
...
SLD_up.to_csv(os.path.join(os.getcwd(), 'ddod_SLD++_300point.csv'), index=False)
#SLD_down.to_csv(os.path.join(os.getcwd(), 'ddod_SLD--_300point.csv'), index=False)
#SLD_n.to_csv(os.path.join(os.getcwd(), 'ddod_SLDn_300point.csv'), index=False)
#SLD_m.to_csv(os.path.join(os.getcwd(), 'ddod_SLDm_300point.csv'), index=False)
...
reffinal.to_csv(os.path.join(os.getcwd(), 'ddod_RQ_300point.csv'), index=False)
